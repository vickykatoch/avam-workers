...
var _avam_socket_services_1 = __webpack_require__(1);
...
self.addEventListener('message', function (evt) {
    _avam_socket_services_1.MessageBroker.instance.onMessage(evt.data, self);
...
Object.defineProperty(exports, "__esModule", { value: true });
var socket_controller_factory_1 = __webpack_require__(4);
var message_notifier_1 = __webpack_require__(14);
var MessageBroker = /** @class */ (function () {
    function MessageBroker() {
        //#endregion
        //#region Instance Fields
        this.controllerContextMap = new Map();
        ...
        this.socketMessageSubscription = message_notifier_1.MessageNotifier.instance.message$.subscribe(this.onSocketMessageReceived.bind(this));
    }
    ...
    MessageBroker.prototype.onMessage = function (workerMessage, context) {
        ...
        try {
            var controller = socket_controller_factory_1.SocketControllerFactory.getController(workerMessage.payload);
        }
        catch (error) {
            console.error(error);
        }
    ...
    MessageBroker.prototype.onSocketMessageReceived = function (message) {
    };
...
Object.defineProperty(exports, "__esModule", { value: true });
var socketio_socket_controller_1 = __webpack_require__(5);
// import throttle from "lodash-es/throttle";
var SocketControllerFactory = /** @class */ (function () {
    function SocketControllerFactory() {
    }
    SocketControllerFactory.getController = function (connectionInfo) {
        var key = connectionInfo.type + "-" + connectionInfo.name;
        if (!SocketControllerFactory.controllers.has(key)) {
            SocketControllerFactory.controllers.set(key, SocketControllerFactory.resolveController(connectionInfo.type));
        }
        return SocketControllerFactory.controllers.get(key);
    };
    SocketControllerFactory.resolveController = function (type) {
        if (type === 'SOCKETIO') {
            return new socketio_socket_controller_1.SocketIOSocketController();
        }
        throw new Error('Unknown connection type');
    };
    SocketControllerFactory.controllers = new Map();
    return SocketControllerFactory;
}());
exports.SocketControllerFactory = SocketControllerFactory;
...
Object.defineProperty(exports, "__esModule", { value: true });
var socket_controller_1 = __webpack_require__(6);
var SocketIOSocketController = /** @class */ (function (_super) {
    __extends(SocketIOSocketController, _super);
    function SocketIOSocketController() {
        return _super !== null && _super.apply(this, arguments) || this;
    }
    SocketIOSocketController.prototype.onMessage = function (message) {
        console.log('Message Received on SocketIO');
    };
    return SocketIOSocketController;
}(socket_controller_1.SocketController));
exports.SocketIOSocketController = SocketIOSocketController;
...
var MessageNotifier = /** @class */ (function () {
    function MessageNotifier() {
        ...
        this.message$ = this.notifier.asObservable();
    ...
    Object.defineProperty(MessageNotifier, "instance", {
        get: function () {
    ...
    //#endregion
    //#region Public Methods
    MessageNotifier.prototype.notify = function (message) {
        this.notifier.next(message);
    };
    //#region Static Members
    MessageNotifier._instance = new MessageNotifier();
